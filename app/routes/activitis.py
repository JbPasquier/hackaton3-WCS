...
@app.route('/flaskang/activitis', methods = ['GET'])
def get_all_activitis():
    entities = activitis.Activitis.query.all()
    return json.dumps([entity.to_dict() for entity in entities])

@app.route('/flaskang/activitis/<int:id>', methods = ['GET'])
...
@app.route('/flaskang/activitis', methods = ['POST'])
...
@app.route('/flaskang/activitis/<int:id>', methods = ['PUT'])
...
@app.route('/flaskang/activitis/<int:id>', methods = ['DELETE'])
